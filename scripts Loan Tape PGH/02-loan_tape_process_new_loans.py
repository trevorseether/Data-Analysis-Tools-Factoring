# -*- coding: utf-8 -*-
"""
Created on Tue Sep  2 09:08:47 2025
...
#%%
cierre = '202601'
ubi = rf'C:\Users\Joseph Montoya\Desktop\LoanTape_PGH\temp\{cierre} news'
...
print(df.shape)
#%%
df.to_excel(f'loans_file_{today_date}_new_loans.xlsx',index = False)
...
#%%
bd_pagos_temp[bd_pagos_temp.duplicated()]
#%%
...
print(df_payments.shape)
#%%
df_payments.to_excel(f'payments_{today_date}_new_loans.xlsx',index=False)
#%%
...
print(data_repayments.shape)
#%%
data_repayments.to_excel(f'repayments_{today_date}_new_loans.xlsx',index=False)
#%%
