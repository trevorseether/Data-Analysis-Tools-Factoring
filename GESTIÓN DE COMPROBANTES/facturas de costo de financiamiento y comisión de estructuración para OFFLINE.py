# -*- coding: utf-8 -*-
"""
Created on Wed Dec 10 15:14:10 2025
...
with pd.ExcelWriter(ubi + f'\\Carga_masiva_Facturas_costo_financiamiento_OFFLINE {hoy_formateado}.xlsx', engine='xlsxwriter') as writer:
...
with pd.ExcelWriter(ubi + f'\\Carga_masiva_Facturas_comision_estructuracion_OFFLINE {hoy_formateado}.xlsx', engine='xlsxwriter') as writer:
    df_costo_fi.to_excel(writer, index=False, sheet_name='Comprobantes')
    df_costo_items.to_excel(writer, index=False, sheet_name='Items')
